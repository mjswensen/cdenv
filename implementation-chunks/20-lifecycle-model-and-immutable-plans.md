# 20 — Build lifecycle models, immutable plans, and category fingerprints

**Parent phase:** [Implementation plan §11.6, §11.8, and Chunk 4](../implementation-plan.md#116-lifecycle-execution-and-recovery)  
**Depends on:** [16](16-image-metadata-and-substitution.md), [17](17-users-mounts-environment-and-host-requirements.md), [18](18-ports-and-docker-options-planning.md), and [19](19-feature-model-and-ordering.md)
...
- Canonically fingerprint each category with the installation keyed digest primitive from [11](11-state-schema-fingerprints-and-migrations.md). Persist only opaque keyed fingerprints, never plan secrets or unkeyed hashes.
