# 39 — Integrate `appPort` publication and port attributes

**Parent phase:** [Implementation plan §11.9 and Chunk 10](../implementation-plan.md#119-declared-ports-and-forwarding-supervisor)  
**Depends on:** [18](18-ports-and-docker-options-planning.md), [22](22-docker-cli-adapter.md), [29](29-compose-planning-and-adapter.md), [36](36-create-and-up-reconciliation.md), and [38](38-list-status-and-output.md)
