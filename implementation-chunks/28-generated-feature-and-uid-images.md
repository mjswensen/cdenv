# 28 — Build generated Feature, metadata, and UID/GID images

**Parent phase:** [Implementation plan §11.4–11.5 and Chunk 6](../implementation-plan.md#chunk-6-features-cache-lockfile-and-generated-images)  
**Depends on:** [22](22-docker-cli-adapter.md), [25](25-image-scenario-orchestration.md), [26](26-feature-sources-cache-and-extraction.md), and [27](27-feature-lockfile-and-lock-command.md)
...
- Prefer the architecture-matched static helper and Rust/Linux filesystem APIs; do not assume `usermod`, `groupmod`, shell, or distro utilities exist.
...
- Frozen/offline Feature builds and all standard workspace quality commands pass.