# 40 — Implement the agent bridge and scoped forwarding supervisor

**Parent phase:** [Implementation plan §11.9 and Chunk 10](../implementation-plan.md#119-declared-ports-and-forwarding-supervisor)  
**Depends on:** [24](24-bollard-exec-streaming.md), [31](31-agent-build-identity-and-embedding.md), [32](32-agent-tool-free-provisioning.md), and [37](37-down-and-operation-recovery.md)
