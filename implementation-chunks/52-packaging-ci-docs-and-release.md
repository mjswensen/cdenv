# 52 — Finish packaging, CI, documentation, and the V1 release gate

**Parent phase:** [Implementation plan §17.7, Chunk 18, and §19](../implementation-plan.md#chunk-18-doctor-packaging-ci-and-release)  
**Depends on:** [49](49-devcontainer-profile-release-gate.md), [50](50-openssh-release-gate.md), and [51](51-read-only-doctor.md)
...
- Verify every workflow and invariant in [§19](../implementation-plan.md#19-v1-definition-of-done). Do not add self-update, editor launching, remote Docker, or other V1 non-goals.
...
- All five baseline quality commands from [05](05-rust-workspace-and-quality-baseline.md), both release suites, and package-content checks pass from a clean locked checkout.
