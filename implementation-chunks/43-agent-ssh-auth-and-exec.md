# 43 — Implement agent SSH authentication and non-PTY exec

**Parent phase:** [Implementation plan §15.1–15.6 and Chunk 12](../implementation-plan.md#chunk-12-agent-ssh-handshake-authentication-and-exec)  
**Depends on:** [31](31-agent-build-identity-and-embedding.md), [33](33-effective-remote-environment.md), and [42](42-ssh-identity-config-and-wrapper.md)
