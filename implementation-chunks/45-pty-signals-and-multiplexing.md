# 45 — Add PTYs, signals, cleanup, and OpenSSH multiplexing

**Parent phase:** [Implementation plan §15.7, §15.9, and Chunk 14](../implementation-plan.md#chunk-14-pty-multiplexing-signals-and-cleanup)  
**Depends on:** [43](43-agent-ssh-auth-and-exec.md) and [44](44-host-proxy-and-post-attach.md)
