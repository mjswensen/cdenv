# 47 — Implement image/Dockerfile rebuild, rollback, and cleanup

**Parent phase:** [Implementation plan §10.6 and Chunk 16](../implementation-plan.md#chunk-16-rebuild-rollback-and-cleanup)  
**Depends on:** [27](27-feature-lockfile-and-lock-command.md), [36](36-create-and-up-reconciliation.md), [41](41-declarative-forwarding-reconciliation.md), and [46](46-direct-tcpip-and-ad-hoc-forward.md)
