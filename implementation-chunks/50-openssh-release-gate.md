# 50 — Build the OpenSSH interoperability release gate

**Parent phase:** [Implementation plan §17.3, §17.6, and Chunk 17](../implementation-plan.md#176-automated-openssh-release-gate)  
**Depends on:** [41](41-declarative-forwarding-reconciliation.md), [44](44-host-proxy-and-post-attach.md), [45](45-pty-signals-and-multiplexing.md), [46](46-direct-tcpip-and-ad-hoc-forward.md), and rebuild flows through [48](48-compose-rebuild-and-partial-recovery.md)
