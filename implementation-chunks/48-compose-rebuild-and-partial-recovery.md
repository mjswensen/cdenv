# 48 — Implement Compose rebuild and partial-state recovery

**Parent phase:** [Implementation plan §10.6, §11.10, and Chunk 16](../implementation-plan.md#chunk-16-rebuild-rollback-and-cleanup)  
**Depends on:** [30](30-compose-managed-lifecycle.md), [41](41-declarative-forwarding-reconciliation.md), and [47](47-image-rebuild-rollback-and-cleanup.md)
