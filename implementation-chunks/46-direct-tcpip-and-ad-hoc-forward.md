# 46 — Implement `direct-tcpip` and foreground `cdenv forward`

**Parent phase:** [Implementation plan §10.9, §15.8, and Chunk 15](../implementation-plan.md#chunk-15-direct-forwarding-and-ad-hoc-cdenv-forward)  
**Depends on:** [41](41-declarative-forwarding-reconciliation.md), [42](42-ssh-identity-config-and-wrapper.md), [44](44-host-proxy-and-post-attach.md), and [45](45-pty-signals-and-multiplexing.md)
