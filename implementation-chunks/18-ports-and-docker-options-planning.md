# 18 — Plan ports and Docker-shaped options

**Parent phase:** [Implementation plan §11.4 and §11.9](../implementation-plan.md#119-declared-ports-and-forwarding-supervisor)  
**Depends on:** [15](15-profile-raw-model-and-validation.md) and [17](17-users-mounts-environment-and-host-requirements.md)
