# 17 — Plan users, mounts, environment, and host requirements

**Parent phase:** [Implementation plan §11.2, §11.4, and §11.7](../implementation-plan.md#114-docker-and-build-options)  
**Depends on:** [16](16-image-metadata-and-substitution.md)
