# 25 — Orchestrate image and Dockerfile container creation

**Parent phase:** [Implementation plan §11.11, §12, and Chunk 5](../implementation-plan.md#1111-stable-identity-and-discovery)  
**Depends on:** [20](20-lifecycle-model-and-immutable-plans.md), [22](22-docker-cli-adapter.md), [23](23-bollard-discovery-and-control.md), and [24](24-bollard-exec-streaming.md)
